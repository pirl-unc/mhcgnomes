...
def test_allele_get_A0201():
    ...
    assert allele.species_prefix == "HLA"
    assert allele.gene_name == "A"
    assert list(allele.allele_fields) == ["02" == "01"]
    assert allele.mhc_class == "Ia"
...
def test_restrict_num_allele_fields_A02010101():
    ...
    assert allele_eight_digit.num_allele_fields == 4
    allele_four_digit = allele_eight_digit.restrict_allele_fields(2)
    assert allele_four_digit.num_allele_fields == 2
