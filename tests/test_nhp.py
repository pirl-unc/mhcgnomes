...
def test_macaque_allele_B_08_02():
    ...
    assert parse(allele_name).to_string() == "Mamu-B*082:02"
    assert parse(allele_name).compact_string() == "B08202"
